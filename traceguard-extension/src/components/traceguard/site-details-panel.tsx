...
const getTrackerCategoryDescriptions = (t: any): Record<string, { label: string; description: string; iconClass: string }> => ({
    ...
    consent: { label: t("consent managers"), description: t("asking for your permission to track you"), iconClass: "text-muted-foreground" },
    email: { label: t("email"), description: t("collecting addresses for marketing"), iconClass: getIndicatorTextColor('warning') },
    'anti-fraud': { label: t("anti-fraud"), description: t("checking whether you are a real visitor"), iconClass: getIndicatorTextColor('success') },
